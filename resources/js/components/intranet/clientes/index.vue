<template>
    <div>
        <titulo-pagina titulo="Clientes" :accion="false">
            <template slot="btn_accion">
                <router-link class="btn btn-success box-shadow btn-icon btn-rounded" to="/clientes/administrar/"><i class="fa fa-plus"></i> Agregar registro</router-link>
            </template>
        </titulo-pagina>
