<template>
    <div>
        <titulo-pagina titulo="Profesionales" :accion="false">
            <template slot="btn_accion">
                <router-link class="btn btn-success box-shadow btn-icon btn-rounded" to="/profesionales/administrar/"><i class="fa fa-plus"></i> Agregar registro</router-link>
            </template>
        </titulo-pagina>
